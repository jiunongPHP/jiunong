...
class WxpayService
{
  ...
  /**
   * 
   * @param type 微信支付商户号 PartnerID 通过微信支付商户资料审核后邮件发送
   * @param type 公众号APPID 通过微信支付商户资料审核后邮件发送
   * @param type https://pay.weixin.qq.com 帐户设置-安全设置-API安全-API密钥-设置API密钥
   */
  ...
  /**
   * 【不需要】@param string $openid 调用【网页授权获取用户信息】接口获取到用户在该公众号下的Openid
